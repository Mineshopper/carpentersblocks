...
public class BlockHandlerCarpentersLadder extends BlockHandlerBase {
    ...
    protected void renderCarpentersBlock(int x, int y, int z)
    {
        ...
        boolean connects_XN = blockXN != null && blockXN.equals(srcBlock) && BlockProperties.getMetadata((TEBase) world.getBlockTileEntity(x - 1, y, z)) == data;
        boolean connects_XP = blockXP != null && blockXP.equals(srcBlock) && BlockProperties.getMetadata((TEBase) world.getBlockTileEntity(x + 1, y, z)) == data;
        boolean connects_ZN = blockZN != null && blockZN.equals(srcBlock) && BlockProperties.getMetadata((TEBase) world.getBlockTileEntity(x, y, z - 1)) == data;
        boolean connects_ZP = blockZP != null && blockZP.equals(srcBlock) && BlockProperties.getMetadata((TEBase) world.getBlockTileEntity(x, y, z + 1)) == data;
