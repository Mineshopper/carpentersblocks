...
public class BlockCarpentersCollapsibleBlock extends BlockCoverable {
    ...
    public BlockCarpentersCollapsibleBlock(int blockID, Material material)
    {
    ...
    private boolean isSlopeBoundary(World world, int x, int y, int z)
    {
        ...
        return (block != null && block.blockMaterial.blocksMovement()) ||
               (blockYN != null && !blockYN.blockMaterial.blocksMovement());
    }
