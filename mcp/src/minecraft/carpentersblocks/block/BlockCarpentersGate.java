...
public class BlockCarpentersGate extends BlockCoverable {
    ...
    public boolean canPlaceBlockAt(World world, int x, int y, int z)
    {
        ...
        return blockYN != null && !blockYN.blockMaterial.isSolid() ? false : super.canPlaceBlockAt(world, x, y, z);
    }
    ...
    private void cycleNeighborGate(TEBase TE, World world, int x, int y, int z)
    {
        ...
        boolean isGateBelow = blockYN != null && blockYN.equals(this) ? true : false;
        boolean isGateAbove = blockYP != null && blockYP.equals(this) ? true : false;
