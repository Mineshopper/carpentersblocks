...
public class BlockCarpentersSlope extends BlockCoverable {
    ...
    public BlockCarpentersSlope(int blockID, Material material)
    {
    ...
    {
        return super.canCoverSide(TE, world, x, y, z, side) || isBlockSolidOnSide(world, x, y, z, ForgeDirection.getOrientation(side));
    }
