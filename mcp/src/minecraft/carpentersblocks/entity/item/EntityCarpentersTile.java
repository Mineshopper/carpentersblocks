...
public class EntityCarpentersTile extends EntityBase {
    ...
    {
        BlockProperties.playBlockSound(worldObj, new ItemStack(Block.hardenedClay), (int) Math.floor(posX), (int) Math.floor(posY), (int) Math.floor(posZ), true);
    }

    public void playDyeSound()
    {
        BlockProperties.playBlockSound(worldObj, new ItemStack(Block.sand), (int) Math.floor(posX), (int) Math.floor(posY), (int) Math.floor(posZ), true);
    }
    ...
    public boolean onValidSurface()
    {
        ...
        Block block = Block.blocksList[worldObj.getBlockId(x_offset, y_offset, z_offset)];

        return !(block != null && !block.isBlockSolidOnSide(worldObj, x_offset, y_offset, z_offset, dir));
    }
