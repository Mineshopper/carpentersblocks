...
public class BlockHandlerCarpentersDaylightSensor extends BlockHandlerBase {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderBlocks)
    {
        ...
        super.renderInventoryBlock(Block.blockLapis, metadata, modelID, renderBlocks);

        /* Redstone inset */

        renderBlocks.setRenderBounds(0.0625D, 0.0625D + yOffset, 0.0625D, 0.125D, 0.1875D + yOffset, 0.9375D);
        super.renderInventoryBlock(Block.blockRedstone, metadata, modelID, renderBlocks);
    ...
    protected void renderCarpentersBlock(int x, int y, int z)
    {
        ...
        if (renderPass == PASS_OPAQUE) {
            ...
            renderBlock(new ItemStack(Block.blockLapis), x, y, z);
            ...
            ItemStack redstone = new ItemStack(Block.blockRedstone);
