...
public class BlockHandlerBase implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderBlocks)
    {
        ...
        if (block instanceof BlockCoverable) {
            ...
            Icon icon = renderBlocks.getIconSafe(((BlockCoverable)block).getIcon());
    ...
    public boolean renderWorldBlock(IBlockAccess blockAccess, int x, int y, int z, Block block, int modelID, RenderBlocks renderBlocks)
    {
        ...
        TileEntity TE_default = blockAccess.getBlockTileEntity(x, y, z);
    ...
    protected Icon getIcon(ItemStack itemStack, int side)
    {
        ...
        Icon icon = renderBlocks.getIconSafe(getUniqueIcon(itemStack, side, BlockProperties.toBlock(itemStack).getIcon(side, itemStack.getItemDamage())));
    ...
    protected void renderChiselDesign(int x, int y, int z, int side)
    {
        ...
        Icon icon = renderBlocks.getIconSafe(IconRegistry.icon_design_chisel.get(DesignHandler.listChisel.indexOf(design)));
        setColorAndRender(new ItemStack(Block.glass), x, y, z, side, icon);
    }
