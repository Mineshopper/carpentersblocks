...
public class StairsTransform {
    ...
    public static void transformAdjacentStairs(World world, int stairsID, int x, int y, int z)
    {
        ...
        TEBase TE_XN = stairs_XN != null ? (TEBase) world.getBlockTileEntity(x - 1, y, z) : null;
        TEBase TE_XP = stairs_XP != null ? (TEBase) world.getBlockTileEntity(x + 1, y, z) : null;
        TEBase TE_ZN = stairs_ZN != null ? (TEBase) world.getBlockTileEntity(x, y, z - 1) : null;
        TEBase TE_ZP = stairs_ZP != null ? (TEBase) world.getBlockTileEntity(x, y, z + 1) : null;
