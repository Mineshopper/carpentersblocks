...
public class BlockCarpentersDaylightSensor extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersDaylightSensor(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
