...
public class BlockCarpentersGarageDoor extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersGarageDoor(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
