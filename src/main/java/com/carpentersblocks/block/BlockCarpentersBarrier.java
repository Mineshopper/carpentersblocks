...
public class BlockCarpentersBarrier extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersBarrier(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
