...
public class BlockCarpentersDoor extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersDoor(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
