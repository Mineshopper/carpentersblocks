...
public class BlockCarpentersLadder extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersLadder(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
