...
public class BlockCarpentersLever extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersLever(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
