...
public class BlockCarpentersBed extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersBed(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
