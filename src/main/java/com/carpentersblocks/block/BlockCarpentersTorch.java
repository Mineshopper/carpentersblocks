...
public class BlockCarpentersTorch extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersTorch(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
