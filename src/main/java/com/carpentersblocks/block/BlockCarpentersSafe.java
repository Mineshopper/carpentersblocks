...
public class BlockCarpentersSafe extends AbstractCoverableBlock implements IStateImplementor {

	private static StateMap _stateMap;
	
	public BlockCarpentersSafe(Properties properties, StateMap stateMap) {
		super(properties);
		_stateMap = stateMap;
	}
