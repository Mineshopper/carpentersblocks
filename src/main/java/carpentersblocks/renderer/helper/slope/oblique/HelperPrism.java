...
public class HelperPrism extends RenderHelper {
     ...
     */
    public static void renderWedgeSlopeZNeg(RenderBlocks renderBlocks, double x, double y, double z, Icon icon)
    {
     ...
     */
    public static void renderWedgeSlopeZPos(RenderBlocks renderBlocks, double x, double y, double z, Icon icon)
    {
     ...
     */
    public static void renderWedgeSlopeXNeg(RenderBlocks renderBlocks, double x, double y, double z, Icon icon)
    {
     ...
     */
    public static void renderWedgeSlopeXPos(RenderBlocks renderBlocks, double x, double y, double z, Icon icon)
    {
