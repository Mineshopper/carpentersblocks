...
public class BlockHandlerCarpentersBarrier extends BlockHandlerBase {
    ...
    {
        if (renderBlocks.blockAccess.getBlock(x, y, z).equals(BlockRegistry.blockCarpentersBarrier))
        {
            TEBase TE = (TEBase) renderBlocks.blockAccess.getTileEntity(x, y, z);
    ...
    private void renderPicketFence(ItemStack itemStack, int x, int y, int z)
    {
        ...
        boolean isBarrierAbove = renderBlocks.blockAccess.getBlock(x, y + 1, z).equals(BlockRegistry.blockCarpentersBarrier);
        boolean isBarrierBelow = renderBlocks.blockAccess.getBlock(x, y - 1, z).equals(BlockRegistry.blockCarpentersBarrier);
