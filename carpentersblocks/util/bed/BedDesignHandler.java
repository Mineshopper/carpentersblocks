package carpentersblocks.util.bed;
...
public class BedDesignHandler {
    ...
    public static boolean init(FMLPreInitializationEvent event)
    {
            ...
            while (enumeration.hasMoreElements())
            {
                ...
                if (zipentry.getName().contains("/bed/design_"))
                {
                    ...
                    if (numDesign > maxNum - 1 || numDesign < 1) {
                        ...
                        ModLogger.log(Level.WARN, "Encountered out of range bed design " + zipentry.getName() + ". This file will be ignored.");
        ...
        {
            ModLogger.log(Level.WARN, "Encountered a problem while initializing bed designs: " + e.getMessage());
        }
