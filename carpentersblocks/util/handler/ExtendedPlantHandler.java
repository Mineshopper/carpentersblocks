...
public class ExtendedPlantHandler {
    ...
    public static boolean init()
    {
        try {
            ...
            ModLogger.log(Level.WARN, "Extended plant support integration failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public static boolean canThisPlantGrowOnThisBlockID(int blockID)
    {
        ...
        try {
            ...
            ModLogger.log(Level.WARN, "Extended plant compatibility failed, disabling plant support integration: " + e.getMessage());
