...
public class FeatureRegistry {
    ...
    public static void initFeatures(FMLPreInitializationEvent event)
    {
        ...
        Property enableTorchWeatherEffectsProp = config.get("torch", "enableTorchWeatherEffects", enableTorchWeatherEffects);
        enableTorchWeatherEffectsProp.comment = "This controls whether torches are extinguishable when exposed to rain or snow.";
