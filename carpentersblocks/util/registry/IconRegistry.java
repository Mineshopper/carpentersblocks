...
public class IconRegistry {
	...
	public static Icon icon_overlay_hay_top;
	...
	public void loadTextures(TextureStitchEvent.Pre event)
	{
		if (event.map.textureType == 0) {
			icon_missing = event.map.getMissingIcon();
	...
	public static void registerIcons(IconRegister iconRegister)
	{
		...
		icon_overlay_hay_top = iconRegister.registerIcon("carpentersblocks:overlay/overlay_hay_top");
