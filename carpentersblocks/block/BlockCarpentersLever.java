...
public class BlockCarpentersLever extends BlockBase
{
	...
	protected boolean onHammerLeftClick(TECarpentersBlock TE, EntityPlayer entityPlayer)
	{
		...
		if (!TE.worldObj.isRemote) {
			...
			notifySideNeighbor(TE.worldObj, TE.xCoord, TE.yCoord, TE.zCoord, Lever.getType(data));
		} else {
			switch (polarity) {
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z)
	{
		...
		case 0:
			offset = 0.25F;
			setBlockBounds(0.5F - offset, 0.4F, 0.5F - offset, 0.5F + offset, 1.0F, 0.5F + offset);
			break;
		case 1:
			setBlockBounds(0.0F, 0.2F, 0.5F - offset, offset * 2.0F, 0.8F, 0.5F + offset);
			break;
		case 2:
			setBlockBounds(1.0F - offset * 2.0F, 0.2F, 0.5F - offset, 1.0F, 0.8F, 0.5F + offset);
			break;
		case 3:
			setBlockBounds(0.5F - offset, 0.2F, 0.0F, 0.5F + offset, 0.8F, offset * 2.0F);
			break;
		case 4:
			setBlockBounds(0.5F - offset, 0.2F, 1.0F - offset * 2.0F, 0.5F + offset, 0.8F, 1.0F);
			break;
		case 7:
			offset = 0.25F;
			setBlockBounds(0.5F - offset, 0.4F, 0.5F - offset, 0.5F + offset, 1.0F, 0.5F + offset);
		...
		default:
			offset = 0.25F;
			setBlockBounds(0.5F - offset, 0.0F, 0.5F - offset, 0.5F + offset, 0.6F, 0.5F + offset);
			break;
		}
