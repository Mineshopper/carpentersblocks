...
public class BlockCarpentersHatch extends BlockBase
{
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z)
    {
        ...
        if (isHigh) {
            this.setBlockBounds(0.0F, 1.0F - 0.1875F, 0.0F, 1.0F, 1.0F, 1.0F);
        } else {
        ...
        if (isOpen)
        {
        	switch (dir) {
        	case 0:
        		this.setBlockBounds(0.0F, 0.0F, 1.0F - 0.1875F, 1.0F, 1.0F, 1.0F);
        		break;
        	case 1:
        		this.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 0.1875F);
        		break;
        	case 2:
        		this.setBlockBounds(1.0F - 0.1875F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
        		break;
        	case 3:
