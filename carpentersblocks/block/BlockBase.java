...
public class BlockBase extends BlockContainer {
	 ...
	 */
	protected boolean isOp(EntityLiving entityLiving)
	{
		if (!entityLiving.worldObj.isRemote) {
			return ((EntityPlayerMP)entityLiving).mcServer.getConfigurationManager().areCommandsAllowed(entityLiving.getEntityName());
		} else {
			return false;
		}
	}
	 ...
	 */
	protected boolean canPlayerEdit(TEBase TE, EntityLiving entityLiving)
	{
	 ...
	 */
	protected boolean canPlayerActivate(TEBase TE, EntityLiving entityLiving)
	{
		return true;
	}
