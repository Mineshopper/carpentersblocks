...
public class FancyFluidsHelper {
	...
	public boolean render(TEBase TE, LightingHelper lightingHelper, RenderBlocks renderBlocks, int x, int y, int z, int renderPass)
	{
		...
		boolean isFluid_XN = block_XN != null ? block_XN instanceof BlockFluid || block_XN instanceof ILiquid : false;
		boolean	isFluid_XP = block_XP != null ? block_XP instanceof BlockFluid || block_XP instanceof ILiquid : false;
		boolean	isFluid_ZN = block_ZN != null ? block_ZN instanceof BlockFluid || block_ZN instanceof ILiquid : false;
		boolean	isFluid_ZP = block_ZP != null ? block_ZP instanceof BlockFluid || block_ZP instanceof ILiquid : false;
		boolean	isFluid_XZNP = block_XZNP != null ? block_XZNP instanceof BlockFluid || block_XZNP instanceof ILiquid : false;
		boolean	isFluid_XZPP = block_XZPP != null ? block_XZPP instanceof BlockFluid || block_XZPP instanceof ILiquid : false;
		boolean	isFluid_XZNN = block_XZNN != null ? block_XZNN instanceof BlockFluid || block_XZNN instanceof ILiquid : false;
		boolean	isFluid_XZPN = block_XZPN != null ? block_XZPN instanceof BlockFluid || block_XZPN instanceof ILiquid : false;
